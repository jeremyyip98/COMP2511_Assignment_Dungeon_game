...
public class CompleteGameMenu extends Parent {

    public CompleteGameMenu(Stage window, DungeonApplication dungeonApplication, Dungeon dungeon) throws IOException{
        ...
        Label title = new Label("CONGRATS LEVEL COMPLETE");
        ...
        btnBack.setOnMouseClicked(event -> {
            ...
            dungeonApplication.completeDisappear();
        });
        menu0.getChildren().addAll(title, btnBack);
